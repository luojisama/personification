...
class Config(BaseModel):
    ...
    personification_qwen_web_job_timeout: float = 120.0
    personification_qwen_web_idle_timeout: float = 300.0
    personification_qwen_web_video_max_bytes: int = 268435456
    personification_qwen_web_audio_max_bytes: int = 67108864
    personification_qwen_web_output_max_chars: int = 16000
