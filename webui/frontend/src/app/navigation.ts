...
export const NAVIGATION_TREE: NavigationNode[] = [
  ...
  group("persona", "拟人与记忆", "data", [
    ...
    { id: "groups", label: "群信息", aliases: ["群目录", "成员", "群知识", "Peer Bot"], icon: "data", legacy: "groups", dataSource: "/api/v2/groups", leaves: [{ id: "list", label: "群列表", slug: "list" }, { id: "detail", label: "群详情", slug: "detail" }, { id: "knowledge", label: "知识与风格", slug: "knowledge" }, { id: "members", label: "成员与别名", slug: "members" }, { id: "peer-bots", label: "Peer Bot 协作", slug: "peer-bots" }] },
