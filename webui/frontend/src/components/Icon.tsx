...
const paths: Record<IconName, React.ReactNode> = {
  overview: <><path d="M3 4h7v7H3zM14 4h7v4h-7zM14 12h7v8h-7zM3 15h7v5H3z" /></>,
  route: <><circle cx="5" cy="6" r="2" /><circle cx="19" cy="6" r="2" /><circle cx="12" cy="18" r="2" /><path d="M7 6h10M6.5 8l4.2 8M17.5 8l-4.2 8" /></>,
  ...
  unknown: <><circle cx="12" cy="12" r="9" /><path d="M9.8 9a2.4 2.4 0 1 1 3 2.3c-.8.3-.8 1.1-.8 1.7M12 17h.01" /></>,
  clock: <><circle cx="12" cy="12" r="9" /><path d="M12 7v6l4 2" /></>,
  tool: <><path d="m14.5 5.5 4-2-2 4 2 2 2-1-1 4-4 1-1-2-6.5 6.5-2-2 6.5-6.5-2-2-4 1 1-4 4-1z" /></>,
  shield: <><path d="M12 2 20 5v6c0 5-3.5 8.5-8 11-4.5-2.5-8-6-8-11V5z" /><path d="m8 12 2.5 2.5L16 9" /></>,
};
