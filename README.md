...
| 联网与工具 | Provider 原生搜索、免配置搜索引擎链（萌娘百科/必应国内秒级响应优先）、Web Search、Web Fetch、Wiki、天气、新闻、游戏信息、ACG 实体解析、资源与图片检索、用户任务 |
...
| 管理与观测 | 现代化 WebUI、配置热更新（支持有序列表与搜索引擎上下调序/一键预设）、Provider/模型测试、功能体检、Token/额度、Agent 状态、Trace、审计、日志、数据迁移和插件更新 |
