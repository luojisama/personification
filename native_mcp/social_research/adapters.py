...
SPECS: dict[str, PlatformSpec] = {
    "bilibili": PlatformSpec(
        ...
        qr_selectors=('img[src*="qrcode"]', 'canvas[class*="qr"]', '[class*="qrcode"] img', '[class*="qr-code"] canvas'),
    ...
    "douyin": PlatformSpec(
        ...
        qr_selectors=('img[src*="qrcode"]', 'canvas[class*="qr"]', '[class*="login"] canvas', '[class*="qrcode"] img'),
        login_trigger_selectors=('button:has-text("登录")', '[class*="login"]:has-text("登录")'),
        auth_cookie_names=frozenset({"sessionid", "sessionid_ss", "passport_csrf_token"}),
        content_type="video",
        danmaku=True,
    ),
    "tieba": PlatformSpec(
    ...
    "xiaoheihe": PlatformSpec(
        ...
        qr_selectors=('img[src*="qrcode"]', 'img[src*="qr"]', '[class*="qrcode"] img', '[class*="login"] canvas'),
        login_trigger_selectors=('button:has-text("登录")', '[class*="login"]:has-text("登录")'),
