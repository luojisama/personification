...
_COMMANDS: list[CommandHelpEntry] = [
    ...
    CommandHelpEntry(
        path=("qzone", "status"),
        category="qzone",
        summary="查看主动发空间和好友空间互动状态。",
        usage="拟人 空间 状态",
        examples=("拟人 空间 状态", "/persona qzone status"),
        permission="管理员",
        scope="global",
    ),
    CommandHelpEntry(
        path=("qzone", "test"),
        category="qzone",
        summary="对指定好友空间执行一次测试扫描，支持 QQ 号或 @用户。",
        usage="拟人 空间 测试 <QQ号/@用户>",
        examples=("拟人 空间 测试 12345678", "拟人 空间 测试 @某人"),
        permission="管理员",
        scope="global",
    ),
    CommandHelpEntry(
    ...
    CommandHelpEntry(
        path=("model", "route"),
        category="model",
        summary="热切主回复 provider，可在 antigravity-cli、gemini-cli、codex 等 provider 间切换。",
