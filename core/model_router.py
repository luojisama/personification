...
_ROLE_ALIASES = {
    ...
    "main": MODEL_ROLE_AGENT,
    "primary": MODEL_ROLE_AGENT,
    "reply": MODEL_ROLE_AGENT,
    "主模型": MODEL_ROLE_AGENT,
    "主路由": MODEL_ROLE_AGENT,
    "回复": MODEL_ROLE_AGENT,
    "正文": MODEL_ROLE_AGENT,
    ...
    "splitter": MODEL_ROLE_SPLITTER,
    "split": MODEL_ROLE_SPLITTER,
    "分段": MODEL_ROLE_SPLITTER,
    "消息分段": MODEL_ROLE_SPLITTER,
}
